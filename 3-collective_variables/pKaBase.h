...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
#ifndef __PLUMED_colvar_pKaBase_h
#define __PLUMED_colvar_pKaBase_h
#include <vector>
#include <map>
#include <memory>
#include "Colvar.h"
...
class pKaBase : public Colvar {
  ...
  double r0, d0, d1, sum_exp; //MCA: added d2
  private:
  std::map<AtomNumber,unsigned> idxMap;
  

public:
  explicit pKaBase(const ActionOptions&);
  ~pKaBase();
// active methods:
